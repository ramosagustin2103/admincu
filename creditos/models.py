		...
		if not self.pdf:
			...
			if self.consorcio.id in [2, 4, 8, 17, 7, 3]: # 2 Demo, 4 Prado, 8 Praderas, 17 Terrazas, 7 Chacras, 3 jardines
				...
				if total_adeudado:
					...
					texto_saldo += " a la fecha, incluyendo capital, intereses y el monto de la presente factura (con el descuento por pronto pago en caso de que te corresponda) es de: ${}".format(abs(total_adeudado))
